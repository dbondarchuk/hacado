    ...
    children: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: "packages",
            title: "admin.navigation.packages",
            href: "/dashboard/services/packages",
            label: "admin.navigation.packages",
            icon: <Package />,
            minimumPlanTier: BillingPlanTier.Solo,
            requiredPermission: { resource: "package", action: "read" },
          },
          {
            id: "sold-packages",
            title: "admin.navigation.soldPackages",
            href: "/dashboard/services/packages/sold",
            label: "admin.navigation.soldPackages",
            icon: <Receipt />,
            minimumPlanTier: BillingPlanTier.Solo,
            requiredPermission: { resource: "package", action: "read" },
          },
