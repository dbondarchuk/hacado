            ...
            props: {
              value: [
                ...
                },
                {
                  ...
                  children: [
                    {
                      text: "Підтверджуємо, що ваш візит на послугу {{option.name}} {{dateTime.full}} з {{member.name}} скасовано.",
                      fontSize: "14px",
                    },
                  ],
                  id: "4_g5MvqMhk",
                },
                {
                  children: [
                    {
                      text: "Будь ласка, зателефонуйте нам за номером {{config.phone}}, якщо хочете обрати інший час.",
                      fontSize: "14px",
                    },
                  ],
                  type: "p",
                ...
                },
                {
                  ...
                  children: [
                    {
                      text: "Сподіваємося побачити вас знову!",
                      fontSize: "14px",
                    },
                  ],
                  id: "J8VSfpARyf",
