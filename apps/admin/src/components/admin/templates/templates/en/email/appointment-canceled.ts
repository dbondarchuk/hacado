            ...
            props: {
              value: [
                ...
                },
                {
                  ...
                  children: [
                    {
                      text: "This confirms that your appointment for {{option.name}} on {{dateTime.full}} with {{member.name}} has been canceled.",
                      fontSize: "14px",
                    },
                  ],
                  id: "4_g5MvqMhk",
                },
                {
                  children: [
                    {
                      text: "Please give us a call at {{config.phone}} if you would like to book another time.",
                      fontSize: "14px",
                    },
                  ],
                  type: "p",
