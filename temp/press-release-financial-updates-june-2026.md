...
In your payments list, you can now **open full payment details from the date column**. Tap the date on any row and see the information you need in one place, including fees and related context, without hunting through menus.
...
3. Check in-store sync settings in your PayPal, Square, or Stripe app setup. Square and Stripe enable sync by default on connect; PayPal users can turn it on from their app settings.
