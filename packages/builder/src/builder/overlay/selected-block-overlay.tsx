...
type SelectedBlockOverlayProps = {
  top: number;
  left: number;
  width: number;
  height: number;
...
export const SelectedBlockOverlay = forwardRef<
  HTMLDivElement,
  SelectedBlockOverlayProps
>(function SelectedBlockOverlay(
  { top, left, width, height, id, handleRef, onResize, startResize },
  ref,
) {
